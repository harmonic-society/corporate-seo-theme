                ...
                <div class="ceo-text">
                    ...
                    <div class="message-content">
                        <p class="message-paragraph">
                            Harmonic Society株式会社は、「社会の調和」という理念を掲げ、<br>
                            人と技術が無理なく共存できる未来を目指しています。
                        </p>
                        <p class="message-paragraph">
                            テクノロジーが急速に発展する一方で、<br>
                            「変化についていけない」「デジタルが苦手」という声を<br>
                            地域の中小企業の方々から多く聞きます。
                        </p>
                        <p class="message-paragraph">
                            私は、誰かを置き去りにするデジタル化ではなく、<br>
                            "その会社の働き方に合った、やさしいデジタル化" を広げたいと考えています。
                        </p>
                        <p class="message-paragraph">
                            AIやWebシステムは、正しく使えば<br>
                            忙しい現場を助け、<br>
                            人と人が向き合う時間を増やし、<br>
                            地域で挑戦する企業の力になります。
                        </p>
                        <p class="message-paragraph">
                            だからこそ私たちは、<br>
                            高度な専門用語や大掛かりなDXではなく、<br>
                            「必要なところを、必要な分だけ」改善する小さな一歩 を大切にしています。
                        </p>
                        <p class="message-paragraph">
                            その積み重ねが、やがて会社全体を変え、<br>
                            地域を変え、<br>
                            社会の調和につながっていく。
                        </p>
                        <p class="message-paragraph">
                            そう信じて、Harmonic Societyはこれからも<br>
                            中小企業の皆さまとともに歩み続けます。
                        </p>
                    </div>
